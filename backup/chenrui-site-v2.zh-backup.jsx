...
function ProjectsPage({ onNavigate }) {
  ...
  return (
    <PageShell theme="projects">
      ...
      <section style={{ marginBottom: 28, background: "linear-gradient(180deg, rgba(255,255,255,0.52), rgba(255,255,255,0.22))", border: `1px solid ${DS.borderLight}`, borderRadius: 30, padding: 20, boxShadow: "0 18px 48px rgba(115,145,190,0.08)", backdropFilter: "blur(18px)" }}>
      <div style={{ display: "grid", gridTemplateColumns: "1.15fr 0.85fr", gap: 24 }}>
        <div className="editorial-surface" style={{ background: "linear-gradient(145deg, rgba(255,255,255,0.92), rgba(242,248,255,0.8))", border: `1px solid ${DS.borderLight}`, borderRadius: "28px 18px 18px 18px", padding: "28px 28px 30px", boxShadow: "0 16px 42px rgba(98,132,180,0.09)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 14 }}>
          {[
            ...
            <div key={stat.label} className="editorial-surface" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.96), rgba(240,247,255,0.84))", border: `1px solid ${DS.borderLight}`, borderRadius: 18, padding: "22px 20px", boxShadow: "0 12px 30px rgba(107,140,188,0.08)" }}>
              ...
              <div style={{ fontFamily: DS.font, fontSize: 28, fontWeight: 700, color: DS.accentDeep }}>{stat.value}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <section style={{ marginBottom: 30, background: "linear-gradient(180deg, rgba(255,255,255,0.5), rgba(255,255,255,0.18))", border: `1px solid ${DS.borderLight}`, borderRadius: 32, padding: 20, boxShadow: "0 18px 46px rgba(108,142,189,0.08)", backdropFilter: "blur(18px)" }}>
      <div
        className="interactive-node editorial-card"
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 24, position: "relative" }}>
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
              <span style={{ fontSize: 36 }}>{featuredProject.icon}</span>
              <div style={{ fontFamily: DS.font, fontSize: 34, fontWeight: 700, color: DS.accentDeep }}>{featuredProject.title}</div>
            </div>
      ...
      <section style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.52), rgba(255,255,255,0.18))", border: `1px solid ${DS.borderLight}`, borderRadius: 32, padding: 20, boxShadow: "0 18px 44px rgba(110,143,190,0.08)", backdropFilter: "blur(18px)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", marginBottom: 18 }}>
        <div>
          ...
          <div style={{ fontFamily: DS.font, fontSize: 26, fontWeight: 700, color: DS.accentDeep }}>
            全部作品
          </div>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 24 }}>
        {PROJECTS.map((p, index) => (
          ...
          >
            <div style={{ height: 152, background: p.cover, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 26px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ padding: "24px 26px 26px" }}>
              ...
              <div style={{ fontFamily: DS.font, fontSize: 22, fontWeight: 700, color: DS.accentDeep, marginBottom: 8 }}>{p.title}</div>
...
function ProjectDetailPage({ project, onNavigate }) {
  ...
  return (
    <div style={{ background: "linear-gradient(180deg, #F7FBFF 0%, #ECF5FF 100%)", minHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }} className="route-slide" >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.15fr 0.85fr", gap: 24, alignItems: "end" }}>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 14 }}>
                  <span style={{ fontSize: 38 }}>{project.icon}</span>
                  <h1 style={{ fontFamily: DS.font, fontSize: 42, fontWeight: 700, color: DS.accentDeep, margin: 0 }}>
                    {project.title}
                  </h1>
                </div>
                <p style={{ fontFamily: DS.font, fontSize: 18, color: "rgba(62,84,116,0.88)", margin: "0 0 22px", lineHeight: 1.8, maxWidth: 620 }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "42px 32px 88px", position: "relative", zIndex: 1 }} className="route-slide" >
        <div style={{ display: "grid", gridTemplateColumns: "0.74fr 1.26fr", gap: 24 }}>
          ...
          <div style={{ display: "grid", gap: 18 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }} className="route-slide">
            ...
            >
              ...
              <div style={{ fontFamily: DS.font, fontSize: 28, fontWeight: 700, color: DS.accentDeep, marginBottom: 14, position: "relative" }}>
                {project.fullContent.sections[activeSection].title}
              </div>
              <div style={{ fontFamily: DS.font, fontSize: 15, color: "rgba(64,84,114,0.88)", lineHeight: 1.95, position: "relative", whiteSpace: "pre-wrap" }}>
                {project.fullContent.sections[activeSection].content}
              </div>
            </div>

            <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 16 }} className="route-slide">
...
function KnowledgePage({ onNavigate }) {
  ...
  return (
    <PageShell theme="knowledge">
      ...
      <section style={{ marginBottom: 28, background: "linear-gradient(180deg, rgba(255,255,255,0.52), rgba(255,255,255,0.2))", border: `1px solid ${DS.borderLight}`, borderRadius: 30, padding: 20, boxShadow: "0 18px 44px rgba(111,145,190,0.08)", backdropFilter: "blur(18px)" }}>
      <div style={{ display: "grid", gridTemplateColumns: "0.92fr 1.08fr", gap: 24 }}>
        <div className="editorial-surface" style={{ background: "linear-gradient(145deg, rgba(255,255,255,0.94), rgba(244,249,255,0.84))", border: `1px solid ${DS.borderLight}`, borderRadius: "18px 28px 18px 18px", padding: "28px 28px 30px", boxShadow: "0 14px 36px rgba(104,140,190,0.08)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
          {[
            ...
            <div key={item.label} className="editorial-surface" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.96), rgba(241,248,255,0.84))", border: `1px solid ${DS.borderLight}`, borderRadius: 18, padding: "20px 18px", boxShadow: "0 12px 30px rgba(104,140,190,0.08)" }}>
      ...
      <section style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.5), rgba(255,255,255,0.18))", border: `1px solid ${DS.borderLight}`, borderRadius: 32, padding: 20, boxShadow: "0 18px 44px rgba(110,143,190,0.08)", backdropFilter: "blur(18px)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", marginBottom: 18 }}>
        <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: 22 }}>
        {KNOWLEDGE.map((cat, index) => (
          <div
            ...
            style={{
              gridColumn: index === 0 ? "span 7" : index === 1 ? "span 5" : "span 12",
              borderRadius: index === 2 ? "18px 28px 18px 18px" : "24px",
              overflow: "hidden",
              cursor: "pointer",
              background: index === 2
          ...
          >
            ...
            <div style={{ position: "relative", padding: index === 2 ? "26px 28px" : "24px 24px 26px", minHeight: index === 2 ? 220 : 280, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
                  <span style={{ fontSize: index === 2 ? 34 : 30 }}>{cat.icon}</span>
                ...
                <h3 style={{ fontFamily: DS.font, fontSize: index === 2 ? 24 : 22, fontWeight: 700, color: DS.accentDeep, margin: "0 0 8px" }}>
                  {cat.title}
                </h3>
...
function AboutPage({ onNavigate }) {
  ...
  return (
    <PageShell theme="about">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.08fr 0.92fr", gap: 24, marginBottom: 28 }}>
        <div style={{ background: "linear-gradient(145deg, rgba(255,255,255,0.94), rgba(244,248,255,0.84))", border: `1px solid ${DS.borderLight}`, borderRadius: "30px 18px 18px 18px", padding: "30px 30px 32px", boxShadow: "0 16px 40px rgba(106,139,187,0.08)" }}>
          ...
          <div style={{ fontFamily: DS.font, fontSize: 30, fontWeight: 700, color: DS.accentDeep, marginBottom: 12 }}>
            搭建自己的叙事方式。
          </div>
        ...
        <div style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.94), rgba(244,248,255,0.84))", border: `1px solid ${DS.borderLight}`, borderRadius: "18px 30px 18px 18px", padding: "28px 26px 30px", boxShadow: "0 16px 40px rgba(106,139,187,0.08)" }}>
          <div style={{ fontFamily: DS.mono, fontSize: 10, color: "rgba(86,118,164,0.78)", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 16 }}>
            Working Style
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "0.95fr 1.05fr", gap: 24, marginBottom: 28 }}>
        <div ref={barsRef} style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.94), rgba(244,248,255,0.84))", border: `1px solid ${DS.borderLight}`, borderRadius: 24, padding: "28px 28px 30px", boxShadow: "0 16px 40px rgba(106,139,187,0.08)" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.94), rgba(244,248,255,0.86))", borderRadius: 26, padding: "34px 38px", border: `1px solid ${DS.borderLight}`, boxShadow: "0 16px 40px rgba(106,139,187,0.08)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
          <div>
            ...
            <h3 style={{ fontFamily: DS.font, fontSize: 22, fontWeight: 700, color: DS.accentDeep, margin: "0 0 8px" }}>
              Contact Me
            </h3>
